...
let producto1 = new Producto(1, "Skate Completo PROFESIONAL","TUXS MAPLE", "Hombre", "./img/skt1.png", 150000)
let producto2 = new Producto(2, "Skate Completo","TUXS ANIMAL SERIES", "Hombre", "./img/skt2.jpg", 30000)
let producto3 = new Producto(3, "Skate Completo Red Dragon","Hit Twice", "Hombre", "./img/skt3.jpg", 20000)
let producto4 = new Producto(4, "Skate Completo SKT SKT NH HK","Creature Logo", "Hombre", "./img/skt4.jpg", 55000)
let producto5 = new Producto(5, "Skate Completo SKT FEMALE","Creature Logo", "Mujer", "./img/skt5.jpg", 155000)
let producto6 = new Producto(6, "Skate Completo AMKM PINK POWER","Creature Logo", "Mujer", "./img/skt6.jpg", 55000)
